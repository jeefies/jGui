...
set operatorfunc=<SNR>18_easy_align_op
set ruler
...
wincmd w
argglobal
if bufexists("surface.go") | buffer surface.go | else | edit surface.go | endif
balt rect.go
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
wincmd w
argglobal
if bufexists("rect.go") | buffer rect.go | else | edit rect.go | endif
balt color.go
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
silent! normal! zE
let &fdl = &fdl
let s:l = 39 - ((28 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 39
...
wincmd w
argglobal
if bufexists("events.go") | buffer events.go | else | edit events.go | endif
balt timer.go
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
wincmd w
argglobal
if bufexists("window.go") | buffer window.go | else | edit window.go | endif
balt types.go
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
